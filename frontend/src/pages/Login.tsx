    ...
    <section className="relative min-h-screen flex items-center justify-center bg-black overflow-hidden">
      ...
      >
        ...
        <form onSubmit={onSubmit} className="space-y-5">
          <Inputs name="email" type="email" register={register} validationRules={{ required: true, pattern: /^\S+@\S+\.\S+$/ }} />
          <Inputs name="password" type="password" register={register} validationRules={{ required: true, minLength: 6 }} />
          {errorMsg && (
            <motion.p
